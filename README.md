<!-- registry-sync: version=11.8.0; skills=1483; stars=38909; updated_at=2026-05-27T19:36:33+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,483+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,483+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,483+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,483+ Skills](#browse-1483-skills)
...
If you want a faster answer than "browse all 1,483+ skills", start with a tool-specific guide:
